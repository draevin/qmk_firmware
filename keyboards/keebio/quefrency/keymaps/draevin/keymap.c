...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_CM] = LAYOUT_wrapped(
    ...
    TD(TD_CAPS),    _________________COLEMAK_L3________________, _________________COLEMAK_R3________________, KC_RSFT, MO(_FN),
    KC_LCTL,        KC_LGUI, KC_LALT, KC_SPC,  MO(_FN),          XXXXXXX, KC_SPC,  KC_RCTL, KC_RGUI, XXXXXXX, KC_RALT, KC_HYPR
  ),

  [_QW] = LAYOUT_wrapped(
    HYPR_T(KC_ESC), ________________NUMBER_LEFT________________, ________________NUMBER_RIGHT_______________, KC_MINS, KC_EQL,  KC_BSPC, KC_DEL,
    KC_TAB,         _________________QWERTY_L1_________________, _________________QWERTY_R1_________________, KC_LBRC, KC_RBRC, KC_BSLS,
    KC_BSPC,        _________________QWERTY_L2_________________, _________________QWERTY_R2_________________, KC_QUOT,          KC_ENT,
    TD(TD_CAPS),    _________________QWERTY_L3_________________, _________________QWERTY_R3_________________, KC_RSFT, MO(_FN),
    KC_LCTL,        KC_LGUI, KC_LALT, KC_SPC,  MO(_FN),          XXXXXXX, KC_SPC,  KC_RCTL, KC_RGUI, XXXXXXX, KC_RALT, KC_HYPR
  ),
  ...
  [_FN] = LAYOUT_wrapped(
    ...
    _______,        ___________________FN_L3___________________, ___________________FN_R3___________________, _______, _______,
    _______,        ___________________BLANK___________________, ___________________BLANK___________________,          CM_QW
  ),
};
