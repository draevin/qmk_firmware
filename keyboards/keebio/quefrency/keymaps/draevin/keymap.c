...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_CM] = LAYOUT_wrapped(
    ...
    KC_LCTL,        KC_LGUI, KC_LALT, KC_SPC,  MO(_FN),          XXXXXXX, KC_SPC,  KC_RCTL, KC_RALT, XXXXXXX, KC_RGUI, KC_HYPR
  ),
  ...
  [_FN] = LAYOUT_wrapped(
    ...
    _______,        ___________________BLANK___________________, ___________________FN_R3___________________, _______, _______,
    _______,        _______, _______, _______, _______,          XXXXXXX, _______, _______, _______, _______, _______, CM_QW
  ),
};
